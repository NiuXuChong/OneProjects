...
#import "UMSocial.h"
@interface ProductViewController ()<UIWebViewDelegate, UMSocialUIDelegate>
...
- (void)shareAction:(UIBarButtonItem *)sender {
    [UMSocialSnsService presentSnsIconSheetView:self appKey:UMAPPK shareText:@"" shareImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:self.goodModel.coverimg]]] shareToSnsNames:[NSArray arrayWithObjects:UMShareToSina,UMShareToTencent,UMShareToRenren, nil] delegate:self];
